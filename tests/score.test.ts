...
describe('score a given roll with a given category', () => {
    it.each([
        ...
        { roll: [1, 1, 1, 2, 1], category: Category.Twos, expected: 1 },
        { roll: [1, 3, 3, 2, 1], category: Category.Threes, expected: 2 },
        { roll: [4, 4, 3, 4, 1], category: Category.Fours, expected: 3 },
        { roll: [5, 5, 5, 5, 5], category: Category.Fives, expected: 5 },
